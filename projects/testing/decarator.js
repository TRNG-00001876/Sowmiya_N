...
function LogExecutionTime(target, propertyKey) {
    ...
    console.log("Method ".concat(propertyKey, " took ").concat((endTime - startTime).toFixed(2), " ms"));
}
var MyClass1 = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            MyClass1.prototype.someMethod = function () {
        ...
        (function () {
            ...
            _someMethod_decorators = [LogExecutionTime];
